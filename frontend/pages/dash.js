                  ...
                  <div className="mt-8 flow-root rounded-md bg-white/5 shadow-2xl ring-1 ring-white/10 px-5">
                    <div className="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                      ...
                      <div className="ml-4 w-80">
                          <h2 className="text-xl text-white font-semibold mb-2">Overall Description</h2>
                          <textarea
...
export const getServerSideProps = withIronSessionSsr(async function getServerSideProps({ req }) {
  ...
  const end_date = `${currentDate.getFullYear()}-${(currentDate.getMonth() + 1).toString().padStart(2, '0')}-${currentDate.getDate().toString().padStart(2, '0')}`;
